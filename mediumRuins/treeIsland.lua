return function(center, surface)
    ...
    surface.set_tiles({
            ...
            {name = "water", position = {center.x + (-5.0), center.y + (-4.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (-3.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (-2.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (-1.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (0.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (1.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (2.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (3.0)}},
            {name = "water", position = {center.x + (-5.0), center.y + (4.0)}},
            {name = "water", position = {center.x + (-4.0), center.y + (-5.0)}},
            ...
            {name = "water", position = {center.x + (-3.0), center.y + (4.0)}},
            {name = "water", position = {center.x + (-2.0), center.y + (-5.0)}},
            {name = "water", position = {center.x + (-2.0), center.y + (-4.0)}},
            ...
            {name = "water", position = {center.x + (-2.0), center.y + (4.0)}},
            {name = "water", position = {center.x + (-1.0), center.y + (-5.0)}},
            {name = "water", position = {center.x + (-1.0), center.y + (-4.0)}},
            {name = "water", position = {center.x + (0.0), center.y + (-5.0)}},
            {name = "water", position = {center.x + (0.0), center.y + (-4.0)}},
            {name = "water", position = {center.x + (1.0), center.y + (-5.0)}},
            {name = "water", position = {center.x + (1.0), center.y + (-4.0)}},
